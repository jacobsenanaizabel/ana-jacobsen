        ...
        <div className="row about mobile">
          <div className="container-about col-md-12">
            <label className="text-about">
              ...
              Curabitur placerat pharetra maximus. Curabitur aliquet ex vitae
              augue ultrices ultrices. Proin arcu purus, accumsan a metus non,
              porta consequat elit. Curabitur placerat pharetra maximus.
              Curabitur aliquet ex vitae augue ultrices ultrices. Proin arcu
              purus, accumsan a metus non, porta consequat elit. Curabitur
              placerat pharetra maximus. Curabitur aliquet ex vitae augue
              ultrices ultrices.
            </label>
          </div>
        </div>
